                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (payments.isEmpty)
                                    ...
                                    const _SectionLabel(text: 'All Transactions'),
          ...
          Row(
            children: [
              Container(
                ...
                height: 36,
                decoration: BoxDecoration(
                  color: const Color(0xFFF9B000).withValues(alpha: 0.15),
...
class _PaymentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final method = payment['payment_method'] ?? payment['method'] ?? '—';
    final transactionId =
        payment['transaction_id'] ??
        payment['payment_intent_id'] ??
        payment['id']?.toString() ??
        '—';
    final createdAt = payment['created_at'] ?? payment['date'] ?? '';
                    ...
                    children: [
                      ...
                      if (createdAt.toString().isNotEmpty) ...[
                        ...
                        _DetailLine(
                          ...
                          label: 'Date & Time',
                          value: _formatDate(createdAt.toString()),
                        ),
                      ],
